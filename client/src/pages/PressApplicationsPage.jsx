          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-slate-200 mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 border-t border-slate-100">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-900">6 Industry Sectors</div>
                  <div className="text-xs text-slate-600">Packaging, flexo, coating & pharma</div>
                </div>
              </div>
              <div className="flex items-center gap-3.5">
                <div className="w-11 h-11 rounded-xl bg-blue-50 text-blue-700 border border-blue-200/60 flex items-center justify-center font-black text-sm shrink-0">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-900">Substrate Dynamics</div>
                  <div className="text-xs text-slate-600">BOPP, PET, Foil & Paperboard</div>
                </div>
              </div>
              <div className="flex items-center gap-3.5">
                <div className="w-11 h-11 rounded-xl bg-blue-50 text-blue-700 border border-blue-200/60 flex items-center justify-center font-black text-sm shrink-0">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-900">Chamber Systems</div>
                  <div className="text-xs text-slate-600">Dual blade matched configurations</div>
                </div>
              </div>
            </div>
          </div>
              ...
              {industrialSectors.map((sec, idx) => (
                ...
                >
                  <div>
                    ...
                    <div className="space-y-3 mb-6 text-xs bg-slate-50 p-4 rounded-2xl border border-slate-200">
                      <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {substrateDynamics.map((sub, i) => (
                <div key={i} className="bg-slate-50 p-6 rounded-2xl border border-slate-200 flex flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 mb-2">{sub.substrate}</h3>
                    <p className="text-xs text-slate-500 mb-4 font-medium">{sub.characteristics}</p>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs sm:text-sm">
                <thead className="bg-slate-50/70 border-b border-slate-200 text-slate-700 font-bold uppercase tracking-wider text-xs">
                  <tr>
                    <th className="py-4 px-5">Printing Process</th>
                    <th className="py-4 px-5">Zahn Cup #2</th>
                    <th className="py-4 px-5">Ford Cup #4</th>
                    <th className="py-4 px-5">DIN 4 Cup</th>
                ...
                <tbody className="divide-y divide-slate-100">
                  {viscosityGuide.map((vg, i) => (
                    <tr key={i} className="hover:bg-blue-50/40 transition-colors">
                      <td className="py-4 px-5 font-bold text-slate-900">{vg.process}</td>
                      <td className="py-4 px-5 font-bold text-blue-700">{vg.zahnCup}</td>
                      <td className="py-4 px-5 text-slate-700">{vg.fordCup}</td>
                      <td className="py-4 px-5 text-slate-700">{vg.dinCup}</td>
                      <td className="py-4 px-5 text-slate-700">{vg.notes}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden mb-12">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs sm:text-sm">
                <thead className="bg-slate-50/70 border-b border-slate-200 text-slate-700 font-bold uppercase tracking-wider text-xs">
                  <tr>
                    <th className="py-4 px-5 w-1/4">Operational Parameter</th>
                    <th className="py-4 px-5 w-1/3">Open Tray Systems (Gravure)</th>
                    <th className="py-4 px-5 text-blue-700">Closed Chamber Systems (Flexo)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                  {chamberVsOpen.map((row, i) => (
                    <tr key={i} className="hover:bg-blue-50/40 transition-colors">
                      <td className="py-4 px-5 font-bold text-slate-900">{row.attribute}</td>
                      <td className="py-4 px-5 text-slate-700">{row.openTray}</td>
                      <td className="py-4 px-5 text-blue-700 font-semibold">{row.chambered}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
